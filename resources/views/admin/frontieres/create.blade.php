                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    <form class="form form-horizontal" method="POST" action="{{route('frontieres.store')}}">
                                        @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="lib_frontiere" class="form-control @error('lib_frontiere') is-invalid @enderror" placeholder="Nom de la frontière" value="{{old('lib_frontiere')}}" name="lib_frontiere" required>
                                                    @error('lib_frontiere')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <select id="departements_id" class="form-control @error('departements_id') is-invalid @enderror"  name="departements_id" required>
                                                        ...
                                                        <option value="{{$departement->id}}" {{$departement->id == old("departements_id")}}>{{$departement->lib_departement}}</option>
                                                        @empty
