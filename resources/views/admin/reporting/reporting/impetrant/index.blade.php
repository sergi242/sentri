                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ Route('reporting.impetrant.show') }}" class="form" method="GET">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="categorie_socioprofessionnelle_id" class="form-control @error('categorie_socioprofessionnelle_id') is-invalid @enderror"  value="{{old('categorie_socioprofessionnelle_id')}}" name="categorieId"  required>
                                                <option value="all_categorieId">Tous</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2-theme form-control" id="nationalites_id" name="paysId">
                                                <option value="all_paysId">Tous</option>
