...
<body>
  ...
  @if ($all)
    ...
    <tr>
        <td style="word-wrap: break-word">{{$resultat->nom_employeur}}</td>
        <td>{{$resultat->Masculin}}</td>
        <td>{{$resultat->Feminin}}</td>
    ...
    <tr id="total_cel" style="background-color: #333; color: white;">
        ...
        <td><strong>{{$somme['total_par_nationnalite']}}</strong></td>
    </tr>
        </tbody>
    </table>
  @else
    <table>
        <thead>
            <tr>
                <th  class="black" colspan="4">
                    {{ $employeur }}
                </th>
            </tr>
            <tr>
                <th class="black">Nationnalite</th>
				<th class="black">Homme</th>
				<th class="black">Femme</th>
        ...
        @foreach ($resultats as $resultat)
        <tr>
            <td style="word-wrap: break-word">{{$resultat->nationnalite}}</td>
            <td>{{$resultat->Masculin}}</td>
            <td>{{$resultat->Feminin}}</td>
            <td>{{$resultat->total}}</td>
        </tr>
