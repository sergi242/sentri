          ...
          <table id="table" border="1" cellpadding="5" cellspacing="0">
              <thead>
                  <tr>
                      ...
                      <th class="th" >Nationalité</th>
                  </tr>
              </thead>
              <tbody>
                  @foreach ($impetrants as $key => $impetrant)
                      <tr>
                          <td class="td" style="word-break: break-all;">{{ $key+1 }}</td>
                          <td class="td" style="word-break: break-all;">{{ $impetrant->nom }}</td>
                          <td class="td" style="word-break: break-all;">{{ $impetrant->prenom }}</td>
                          <td class="td" style="word-break: break-word;">{{ $impetrant->sexe }}</td>
                          <td class="td" style="word-break: break-word;">{{ $impetrant->date_naissance }}</td>
                          <td class="td" style="word-break: break-word;">{{ $impetrant->nationalite }}</td>
                      </tr>
                  @endforeach
                  <tr id="total_cel" class="total-row">
                      <td class="td" colspan="6" style="word-wrap: break-word"><strong>TOTAL IMPÉTRANTS : {{ count($impetrants) }}</strong></td>
                  </tr>
              </tbody>
          </table>
