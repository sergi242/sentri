    ...
    $.fn.camshoot = function(options) {
        ...
        settings = $.extend({
            ...
            soundsource:{
                            ...
                            //save:"{{ asset("camera/success.mp3") }}"
                        },
            flasheffect:true,
            imagetype:'png',
            outputdir:'',
            filename:'image',
            services:"{{ route("storePhoto.index",$demande->id) }}",
            ...
            _toolbox:function(){
                    $this.append('<div id="'+settings.parentId+'_toolbox_'+settings.id+'" class="camera_toolbox">'+
                        '<a><img src="{{ asset("camera/left.png") }}" id="delete" title="Hapus foto"></a>'+
                        '<a><img src="{{ asset("camera/middle.png") }}" id="snap" title="Tekan untuk mengambil foto"></a>'+
                        '<a><img src="{{ asset("camera/right.png") }}" id="save" title="Simpan foto"></a>'+
                    '</div>');
                        ...
                        tool.find("#save").click(function(){
                            ...
                            $.post(settings.services,{
                                                        ...
                                                        if(response.code == "200"){
                                                            notify("success","Photo sauvegardée avec succès","Sauvegerde de la photo");
                                                            setTimeout(function(){
                                                                $(location).attr("href","{{ route("demandes.show",$demande->id) }}");
                                                            },2000);
                                                        }else{
                                                            notify("error","Une erreur est survenue lors de la prise de la photo","Sauvegerde de la photo");
                                                        }
