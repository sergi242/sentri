        ...
        <div class="content-body">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>Une liste des personnes ayant fait la demande d'un Visa ou une Carte de Résident Temporaire. <br><a href="{{ Route::current()->uri() }}?layout=cards">Afficher sous forme de block</a></p>
                </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                ...
                                <ul class="list-inline mb-0">
                                    <li><a href="{{ route("demandes.newdocument") }}" class="btn btn-primary" style="color: white">Ajouter une nouvelle demande</a></li>
                                </ul>
                                @endcan
