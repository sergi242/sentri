    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            <div class="col-12">
                ...
                <p>Une liste des personnes ayant fait la demande d'un Visa ou une Carte de R̩sident Temporaire. <br><a href="?layout=cards">Afficher sous forme de block</a></p>
            </div>
                ...
                <div class="col-xl-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            {{-- <h4 class="card-title">Liste des demandes attribu̩es</h4> --}}
