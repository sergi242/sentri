                                ...
                                <div class="card-body">
                                   @if($demande->type_demande == "Visa")
                                    ...
                                    <style>
                                        ...
                                        .text_red{ color: #dc3545; }
                                        .gras{ text-decoration: underline !important; }
                                        br{ line-height: 0px; font-weight: 500; }
                                        label{ font-weight: normal; }
                                        .navbar-semi-dark { background: none; }
                                        a { text-decoration: none; }
                                        input[type="text"], [type="search"]:focus { border: none; border-radius: 4px; }
                                    </style>
                                   @else
                                    <div class="row">
                                        <div class="col-md-1"><img src="{{asset('img/armoi_.png')}}" id="carte" alt=""></div>
                                        <div class="col-md-4">
                                            <p>
                                        ...
                                        <div class="col-md-1"><img src="{{asset('img/congo.svg')}}" id="carte" alt=""></div>
                                    </div>
                                    <div class="row" style="background-color: #000">
                                        <div class="col-md-1"><img src="{{asset('img/armoi_2.png')}}" id="carte" alt=""></div>
                                        <div class="col-md-7">
                                        ...
                                        <div class="col">
                                            <div class="row">
                                                <div class="col-md-3"><img src="{{asset('img/armoi_2.png')}}" id="carte" alt=""></div>
                                                <div class="col-md-9">
                                   ...
                                   @endif
                                    ...
                                    <form class="form form-horizontal" method="POST" action="{{route('demandes.update',$demande->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="force_quittance" id="force_quittance" value="1">
                                        @method("PUT")
                                        <div class="row">
                                            {{-- ── Colonne gauche : pièces, photo, passeport, infos demande ── --}}
                                                    ...
                                                    <div class="col">
                                                        @forelse ($pieces as $p)
                                                            <div class="form-group row">
                                                               ...
                                                               <input type="checkbox" name="justificatifs[]" value="{{$p->id}}" id="{{$p->id}}" class="col-md-6" {{ $demande->pieces->contains($p->id) ? "checked":"" }}>
                                                            </div>
                                                        @empty
                                                        @endforelse
                                                    </div>
...
<h4 class="form-section"><i class="ft-file"></i> Information sur la demande</h4>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-4 label-control" for="commanditaire_id">Agent commanditaire</label>
                                                    <div class="col-md-8 mx-auto">
                                                        <select name="commanditaire_id" id="commanditaire_id"
                                                            ...
                                                            @foreach($usersActifs as $user)
                                                                <option value="{{ $user->id }}"
                                                                    {{ $demande->commanditaire_id == $user->id ? 'selected' : '' }}>
                                            ...
                                            {{-- ── Colonne droite : infos impétrant ── --}}
                                            ...
                                            <!-- FIN LECTEUR PASSEPORT -->
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8 mx-auto">
                                                            <input type="text" id="prenom_mere" class="form-control @error('prenom_mere') is-invalid @enderror" value="{{$demande->impetrant?->prenom_mere}}" name="prenom_mere" placeholder="Prénom de la mère" required>
