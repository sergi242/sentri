...
<div class="app-content content">
    ...
    <button type="button" onclick="window.location.reload()" class="btn btn-sm btn-outline-secondary">
        <i class="la la-refresh"></i> Recharger
                                        ...
                                        <div class="col-md-3">
                                            <h4 style="color: #fff; font-size:25px">REPUBLIQUE DU CONGO</h4>
                                            <h6 class="center tb">Unité * Travail * Progrès</h6>
                                        </div>
                                        <div class="col-md-12">
                                          <span class="tb" style="font-size:13px;">MINISTERE DE L'INTERIEUR ET DE LA DECENTRALISATION - CENTRALE D'INTELIGENCE ET DE DOCUMENTATION-DEPARTEMENT DES MIGRATIONS ET DU CONTROLE DES ETRANGERS</span>
                                        </div>
