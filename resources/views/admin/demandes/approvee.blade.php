...
<style>
    :root {
        ...
        /* Dégradé Vert pour les demandes approuvées */
    ...
    .export-status { font-size: 0.7rem; font-weight: 700; text-transform: uppercase; margin-top: 10px; display: block; }
</style>
@endsection
    ...
    <div class="content-wrapper">
        <div class="content-header row mb-4 align-items-center">
            <div class="col-md-7">
                ...
                <p class="text-muted">Liste des dossiers ayant reçu un avis favorable. 
                    <br><small><a href="?layout=table" class="text-primary fw-600"><i class="la la-table"></i> Mode tableau classique</a></small>
                </p>
            </div>
            <div class="col-md-5 text-md-right">
                <div class="d-flex justify-content-md-end align-items-center" style="gap: 10px;">
                    <input type="text" id="searchDemande" class="form-control border-0 shadow-sm round" placeholder="Rechercher..." style="width: 200px;">
                    <a href="{{ route('demandes.exporttojson') }}" class="btn btn-success round shadow-sm"><i class="la la-file-code"></i> JSON</a>
                </div>
            </div>
        </div>
        ...
        <div class="content-body">
            <div class="row" id="demandeContainer">
                    ...
                    <div class="card modern-card shadow-sm">
                        ...
                        <div class="card-body info-section text-center">
                            ...
                            <div class="row stat-pill no-gutters">
                                ...
                                <div class="col-4">
                                    <small class="text-muted d-block">Export</small>
                                    @if ($demande->export_json == 'exporte')
                                        <span class="badge badge-success badge-pill">OUI</span>
                                    @else
                                        <span class="badge badge-secondary badge-pill">NON</span>
                                    @endif
                                </div>
                            </div>

                            <div class="text-muted font-small-2">
                                <i class="la la-calendar-check"></i> Approuvé le {{ \Carbon\Carbon::parse($demande->date_demande)->format('d/m/Y') }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 text-center py-5">
                    <p class="text-muted">Aucune demande approuvée trouvée.</p>
                </div>
                @endforelse
            </div>
