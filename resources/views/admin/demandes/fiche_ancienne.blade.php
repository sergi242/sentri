                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="textgestion">{{$demande->passeport()?->numero_document}}</div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td  colspan="2" style="font-size: 82%;"><strong>Nom : </strong>&nbsp;&nbsp;
                                        <div class="textgestion">{{$demande->impetrant?->nom}}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td  colspan="2" style="font-size: 82%;"><strong>Prenom : </strong>&nbsp;&nbsp;
                                        <div class="textgestion">{{$demande->impetrant?->prenom}}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td  colspan="2" style="font-size: 82%;"><strong>Nationalité : </strong>{{$demande->impetrant?->pays?->lib_pays}}</td>
                                </tr>
                                <tr>
                                    <td  colspan="2" style="font-size: 82%;"><strong>Date de naissance : </strong>{{$demande->impetrant?->date_naissance}}</td>
                                </tr>
                                <tr>
                                    <td  colspan="2" style="font-size: 82%;"><strong>Lieu de naissance : </strong>{{$demande->impetrant?->lieu_naissance}}</td>
                                </tr>
                                <tr>
                                    <td style="font-size: 82%;">
                                        ...
                                        Masculin
                                        @endif
                                        @if ($demande->impetrant?->sexe == 'Féminin')
                                        Feminin
                                        @endif
                                ...
                                <tr>
                                    <td  colspan="2" style="font-size: 82%;"><strong>Nom du père :&nbsp;</strong><div class="textgestion">{{$demande->impetrant?->nom_pere}}</div></td>
                                </tr>
                                <tr>
                                    <td  colspan="2" style="font-size: 82%;"><strong>Prenom du père :&nbsp;</strong><div class="textgestion">{{$demande->impetrant?->prenom_pere}}</div></td>
                                </tr>
                                <tr>
                                    <td  colspan="2" style="font-size: 82%;"><strong>Nom de la mère :&nbsp;</strong><div class="textgestion">{{$demande->impetrant?->nom_mere}}</div></td>
                                </tr>
                                <tr>
                                    <td  colspan="2" style="font-size: 82%;"><strong>Prenom de la mère :&nbsp;</strong><div class="textgestion">{{$demande->impetrant?->prenom_mere}}</div></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td style="font-size: 82%; position : absolute; table-layout: auto; word-wrap: break-word;">
                                            <div class="textgestion">{{$demande->employeur?->nom_employeur}} </div>
                                  ...
                                  <tr>
                                    <td></td>
                                    <td style="font-size: 82%;" >
                                        <div class="textgestion">{{$demande->employeur->adresse_physique}}</div>
