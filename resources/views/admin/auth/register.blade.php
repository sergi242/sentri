                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="POST" action="{{route('custom.register')}}" novalidate>
                                            @csrf
                                            ...
                                            {{-- <fieldset class="form-group position-relative has-icon-left">
                                                <input type="text" class="form-control @error('phone') is-invalid @enderror " name="phone" placeholder="Exemple : +97121234567" required>
                                                <div class="form-control-position">
                                                    <i class="la la-user"></i>
                                                </div>
                                                @error('phone')
                                            ...
                                            <button type="submit" class="btn btn-outline-info btn-block"><i class="ft-unlock"></i> Créer un compte</button>
                                        </form>
                                    </div>
                                    <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1"><span>Vous avez déjà un compte ?
                                            ?</span></p>
                                    <div class="card-body">
                                        <a href="{{route('login')}}" class="btn btn-outline-laek btn-block"><i class="la la-user"></i>
                                            Se Connecter</a>
                                    </div>
                                    @if (session('success'))
                                <div class="col-sm-12">
