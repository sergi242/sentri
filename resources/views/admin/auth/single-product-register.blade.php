                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                ...
                                <div class="card-content">
                                    <h3 class="text-center">Création du compte</h3>
                                    <div class="card-body">
                                        <form class="form-horizontal" method="POST" action="{{route('custom.register.store')}}" novalidate>
                                            @csrf
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input type="email" value="{{old('email')}}" class="form-control @error('email') is-invalid @enderror " name="email" placeholder="Votre Email" required>
                                            ...
                                            <button type="submit" class="btn btn-info btn-block"><i class="ft-unlock"></i> Créer le compte</button>
                                        </form>
                                    </div>
                                    <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1"><span>Vous avez déjà un compte ?
                                            ?</span></p>
                                    <div class="card-body">
                                        <a href="{{route('custom.single.login')}}" class=""><i class="la la-user"></i>
                                            Se Connecter</a>
                                    </div>
                                </div>
                            </div>
