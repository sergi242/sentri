                ...
                <div class="col-xl-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Liste de flux migratoire de sortie {{ $critere=="jour" ? "d'aujourd'hui":"" }} {{ $critere=="semaine" ? "de cette semaine":"" }} {{ $critere=="mois" ? "du mois courant":"" }} {{ $critere=="annee" ? "de l'année courante":"" }}</h4>
